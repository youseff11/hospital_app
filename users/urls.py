...
from .views import (
    ...
    AIChatView,
    #Pharmacy
    MedicineListView, PharmacyOrderView,
)
...
urlpatterns = [
    ...
    # 8. Pharmacy
    path('pharmacy/medicines/', MedicineListView.as_view(), name='medicine-list'),
    path('pharmacy/orders/', PharmacyOrderView.as_view(), name='pharmacy-orders'),
]